...
cp lekiosk-cli.phar downloads/lekiosk-cli-${TAG}.phar
git add downloads/lekiosk-cli-${TAG}.phar

SHA1=$(openssl sha1 lekiosk-cli.phar)

JSON='name:"lekiosk-cli.phar"'
JSON="${JSON},sha1:\"${SHA1}\""
JSON="${JSON},url:\"http://jcolfej.github.io/lekiosk-cli/downloads/lekiosk-cli-${TAG}.phar\""
